...
export const teekConfig = defineTeekConfig({
  ...
  banner: {
    ...
    imgSrc: ["/bannerImg/bg1.jpeg", "/bannerImg/bg2.jpeg", "/bannerImg/bg3.jpeg", "/bannerImg/bg4.jpeg", "/bannerImg/bg5.jpeg", "/bannerImg/bg6.jpeg"], // Banner 图片链接。bgStyle 为 partImg 或 fullImg 时生效
